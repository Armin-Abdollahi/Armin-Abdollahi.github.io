...
| ![](/images/CIFAR10.png)[**Convolution Neural Network (CNN)**](https://github.com/Armin-Abdollahi/Convolution-Neural-Network) <br> Implement Convolution Neural Network on the CIFAR-10 dataset | ![](/images/Hidrocephali.jpg){: .align-center}[**Hidrocephali Prediction**](https://github.com/Armin-Abdollahi/Hydrocephalus-Prediction) <br> Hydrocephalus detection model using Convolutional Neural Networks (CNNs)|
