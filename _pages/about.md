...
<!--<div id="Infocounter" style="margin: 40px auto 0; font-size: 16px; color: #333; font-weight: bold; font-family: 'Proxima Nova Bold', sans-serif; clear: left; text-align: center; display: flex; flex-wrap: wrap; justify-content: center;">


<div style="text-align: center; border: 1px solid #273B7B; background-color: rgb(255 255 255); padding: 10px; border-radius: 2px; justify-content: center;"><span style="font-weight: bold; display: block; font-size: 40px; color: #273b7b;" tabindex="0" aria-label="6">564</span>Total Users Count</div>
</div>-->
