...
| ![](/images/8Queen.png)[**Genetic Algorithm**](https://github.com/Armin-Abdollahi/Genetic-Algorithm) <br> Solving 8 Queens problem with a Genetic Algorithm | ![](/images/Brain-Tumor.JPG){: .align-center width="300"}[**Brain Tumor Diagnosis**](https://github.com/Armin-Abdollahi/Brain-Tumor-Diagnosis) <br> Brain tumor detection with CNN model on Kaggle dataset|
